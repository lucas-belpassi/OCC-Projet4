...
<body>
    <div class="container-fluid">
        ...
        <!-- Confirmation de supression du chapitre -->
        <section class="admin-table py-4">
            <div class="row">
                <div class="col-md-10 offset-1 text-center">
                    <div class="text-light pb-5 pt-5">
                        <h3>Êtes vous sûr de vouloir supprimer le chapitre ? </h2>
                    </div>
                    <div class="pt-5 pb-5">
                        <button type="submit" class="btn btn-danger btn-lg">Supprimer</button>
                        <button type="submit" class="btn btn-outline-light btn-lg">Annuler</button>
                    </div>
                </div>
                </form>
            </div>
